...
# Player
playerImg = pygame.image.load("C:\Users\user\Desktop\Saiyur\Saiyur homework\html\space invader game\download.jpg")
...
def isCollision(enemyX, enemyY, bulletX, bulletY):
    # Check if there is a collisoin betwween the enemy and a bullet
...
playerX += playerX_change 
    ...
    for i in range (num_of_enemies):
        ...
        if isCollision(enemyX[i], enemy[i], bulletX,  bulletY):
            ...
            bullet_state = "ready" 
            score_value += 1
            enemyX[i] = random.randaint(0, SCREEN_WIDTH - 64)
